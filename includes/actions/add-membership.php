...
class AutomatorWP_WooCommerce_Add_Membership extends AutomatorWP_Integration_Action {
    ...
    public function register() {
        ...
        automatorwp_register_action( $this->action, array(
            ...
            'label'             => __( 'Add user to membership', 'automatorwp-woocommerce' ),
            'select_option'     => __( 'Add user to <strong>membership</strong>', 'automatorwp-woocommerce' ),
            /* translators: %1$s: Membership. */
            'edit_label'        => sprintf( __( 'Add user to %1$s', 'automatorwp-woocommerce' ), '{post}' ),
            /* translators: %1$s: Membership. */
            'log_label'         => sprintf( __( 'Add user to %1$s', 'automatorwp-woocommerce' ), '{post}' ),
            'options'           => array(
