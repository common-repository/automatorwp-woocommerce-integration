...
function automatorwp_woocommerce_get_tags( $tags ) {
    ...
    $tags['woocommerce_billing'] = array(
        'label' => __( 'Customer Billing Address', 'automatorwp-woocommerce-integration' ),
        'tags'  => array(),
    ...
    $tags['woocommerce_shipping'] = array(
        'label' => __( 'Customer Shipping Address', 'automatorwp-woocommerce-integration' ),
        'tags'  => array(),
        'icon'  => AUTOMATORWP_WOOCOMMERCE_URL . 'assets/woocommerce.svg',
    );
...
function automatorwp_woocommerce_order_tags() {
    ...
    $order_tags = array(
        'woocommerce_order_id' => array(
            'label'     => __( 'Order ID', 'automatorwp-woocommerce-integration' ),
            'type'      => 'integer',
            'preview'   => '123',
        ),
        'woocommerce_order_number' => array(
            'label'     => __( 'Order Number', 'automatorwp-woocommerce-integration' ),
            'type'      => 'integer',
            'preview'   => '123',
        ),
        'woocommerce_order_status' => array(
            'label'     => __( 'Order Status', 'automatorwp-woocommerce-integration' ),
            'type'      => 'text',
            'preview'   => __( 'Completed', 'automatorwp-woocommerce-integration' ),
        ),
        'woocommerce_order_date_created' => array(
            'label'     => __( 'Order Date Created', 'automatorwp-woocommerce-integration' ),
            'type'      => 'text',
            'preview'   => date( 'Y-m-d H:i:s' ),
        ),
        'woocommerce_order_date_paid' => array(
            'label'     => __( 'Order Date Paid', 'automatorwp-woocommerce-integration' ),
            'type'      => 'text',
            'preview'   => date( 'Y-m-d H:i:s' ),
        ),
        'woocommerce_order_customer_ip_address' => array(
            'label'     => __( 'Order Customer IP Address', 'automatorwp-woocommerce-integration' ),
            'type'      => 'text',
            'preview'   => '255.255.255.255',
        ),
        'woocommerce_order_coupon_codes' => array(
            'label'     => __( 'Order Coupon Codes', 'automatorwp-woocommerce-integration' ),
            'type'      => 'text',
            'preview'   => 'CODE01, CODE02',
        ),
        'woocommerce_order_subtotal' => array(
            'label'     => __( 'Order Subtotal', 'automatorwp-woocommerce-integration' ),
            'type'      => 'float',
            'preview'   => '123.45',
        ),
        'woocommerce_order_discount_total' => array(
            'label'     => __( 'Order Discount', 'automatorwp-woocommerce-integration' ),
            'type'      => 'float',
            'preview'   => '123.45',
        ),
        'woocommerce_order_total_tax' => array(
            'label'     => __( 'Order Tax', 'automatorwp-woocommerce-integration' ),
            'type'      => 'float',
            'preview'   => '123.45',
        ),
        'woocommerce_order_total' => array(
            'label'     => __( 'Order Total', 'automatorwp-woocommerce-integration' ),
            'type'      => 'float',
            'preview'   => '123.45',
        ),
        'woocommerce_order_meta:META_KEY' => array(
            'label'     => __( 'Order Meta', 'automatorwp-woocommerce' ),
            'type'      => 'text',
            'preview'   => __( 'Order meta value, replace "META_KEY" by the order meta key', 'automatorwp-woocommerce' ),
        ),
    );
    ...
    foreach( automatorwp_woocommerce_get_address_fields() as $field ) {
        ...
        $order_tags['woocommerce_order_billing_' . $field] = array(
            'label'     => sprintf( __( 'Billing %s', 'automatorwp-woocommerce-integration'  ), automatorwp_woocommerce_get_address_field_label( $field ) ),
            'type'      => 'text',
            'preview'   => automatorwp_woocommerce_get_address_field_preview( $field ),
        );
    ...
    foreach( automatorwp_woocommerce_get_address_fields() as $field ) {
        ...
        $order_tags['woocommerce_order_shipping_' . $field] = array(
            'label'     => sprintf( __( 'Shipping %s', 'automatorwp-woocommerce-integration'  ), automatorwp_woocommerce_get_address_field_label( $field ) ),
            'type'      => 'text',
            'preview'   => automatorwp_woocommerce_get_address_field_preview( $field ),
        );
