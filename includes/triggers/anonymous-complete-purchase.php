...
class AutomatorWP_WooCommerce_Anonymous_Complete_Purchase extends AutomatorWP_Integration_Trigger {
    ...
    public function register() {
        ...
        automatorwp_register_trigger( $this->trigger, array(
            ...
            'anonymous'         => true,
            'label'             => __( 'Guest completes a purchase', 'automatorwp-woocommerce' ),
            'select_option'     => __( 'Guest completes <strong>a purchase</strong>', 'automatorwp-woocommerce' ),
            /* translators: %1$s: Number of times. */
            'edit_label'        => sprintf( __( 'Guest completes a purchase %1$s time(s)', 'automatorwp-woocommerce' ), '{times}' ),
            'log_label'         => __( 'Guest completes a purchase', 'automatorwp-woocommerce' ),
