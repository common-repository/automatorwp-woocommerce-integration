<?php
/**
 * Anonymous Purchase Product Category
 *
 * @package     AutomatorWP\Integrations\WooCommerce\Triggers\Anonymous_Purchase_Product_Category
...
class AutomatorWP_WooCommerce_Anonymous_Purchase_Product_Category extends AutomatorWP_Integration_Trigger {

    public $integration = 'woocommerce';
    public $trigger = 'woocommerce_anonymous_purchase_product_category';
    ...
    public function register() {
        ...
        automatorwp_register_trigger( $this->trigger, array(
            ...
            'anonymous'         => true,
            'label'             => __( 'Guest purchases a product of a category', 'automatorwp-woocommerce' ),
            'select_option'     => __( 'Guest purchases a product of <strong>a category</strong>', 'automatorwp-woocommerce' ),
            /* translators: %1$s: Term title. %2$s: Number of times. */
            'edit_label'        => sprintf( __( 'Guest purchases a product of %1$s %2$s time(s)', 'automatorwp-woocommerce' ), '{term}', '{times}' ),
            /* translators: %1$s: Term title. */
            'log_label'         => sprintf( __( 'Guest purchases a product of %1$s', 'automatorwp-woocommerce' ), '{term}' ),
...
new AutomatorWP_WooCommerce_Anonymous_Purchase_Product_Category();