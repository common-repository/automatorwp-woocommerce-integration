<?php
/**
 * Anonymous Purchase Product Tag
 *
 * @package     AutomatorWP\Integrations\WooCommerce\Triggers\Anonymous_Purchase_Product_Tag
...
class AutomatorWP_WooCommerce_Anonymous_Purchase_Product_Tag extends AutomatorWP_Integration_Trigger {

    public $integration = 'woocommerce';
    public $trigger = 'woocommerce_anonymous_purchase_product_tag';
    ...
    public function register() {
        ...
        automatorwp_register_trigger( $this->trigger, array(
            ...
            'anonymous'         => true,
            'label'             => __( 'Guest purchases a product of a tag', 'automatorwp-woocommerce' ),
            'select_option'     => __( 'Guest purchases a product of <strong>a tag</strong>', 'automatorwp-woocommerce' ),
...
new AutomatorWP_WooCommerce_Anonymous_Purchase_Product_Tag();