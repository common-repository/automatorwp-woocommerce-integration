<?php
/**
 * Anonymous Purchase Product
 *
 * @package     AutomatorWP\Integrations\WooCommerce\Triggers\Anonymous_Purchase_Product
...
class AutomatorWP_WooCommerce_Anonymous_Purchase_Product extends AutomatorWP_Integration_Trigger {

    public $integration = 'woocommerce';
    public $trigger = 'woocommerce_anonymous_purchase_product';
    ...
    public function register() {
        ...
        automatorwp_register_trigger( $this->trigger, array(
            ...
            'anonymous'         => true,
            'label'             => __( 'Guest purchases a product', 'automatorwp-woocommerce' ),
            'select_option'     => __( 'Guest purchases <strong>a product</strong>', 'automatorwp-woocommerce' ),
            /* translators: %1$s: Post title. %2$s: Number of times. */
            'edit_label'        => sprintf( __( 'Guest purchases %1$s %2$s time(s)', 'automatorwp-woocommerce' ), '{post}', '{times}' ),
            /* translators: %1$s: Post title. */
            'log_label'         => sprintf( __( 'Guest purchases %1$s', 'automatorwp-woocommerce' ), '{post}' ),
...
new AutomatorWP_WooCommerce_Anonymous_Purchase_Product();