...
class AutomatorWP_WooCommerce_Complete_Purchase extends AutomatorWP_Integration_Trigger {
    ...
    public function register() {
        ...
        automatorwp_register_trigger( $this->trigger, array(
            ...
            'label'             => __( 'User completes a purchase', 'automatorwp-woocommerce' ),
            'select_option'     => __( 'User completes <strong>a purchase</strong>', 'automatorwp-woocommerce' ),
            /* translators: %1$s: Number of times. */
            'edit_label'        => sprintf( __( 'User completes a purchase %1$s time(s)', 'automatorwp-woocommerce' ), '{times}' ),
            'log_label'         => __( 'User completes a purchase', 'automatorwp-woocommerce' ),
