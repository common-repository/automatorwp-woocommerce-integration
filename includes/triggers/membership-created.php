...
class AutomatorWP_WooCommerce_Membership_Created extends AutomatorWP_Integration_Trigger {
    ...
    public function register() {
        ...
        automatorwp_register_trigger( $this->trigger, array(
            ...
            'label'             => __( 'User is added to a membership', 'automatorwp-woocommerce' ),
            'select_option'     => __( 'User is <strong>added</strong> to a <strong>membership</strong>', 'automatorwp-woocommerce' ),
            /* translators: %1$s: Post title. %2$s: Number of times. */
            'edit_label'        => sprintf( __( 'User is added to %1$s %2$s time(s)', 'automatorwp-woocommerce' ), '{post}', '{times}' ),
            /* translators: %1$s: Post title. */
            'log_label'         => sprintf( __( 'User is added to %1$s', 'automatorwp-woocommerce' ), '{post}' ),
