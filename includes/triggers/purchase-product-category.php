...
class AutomatorWP_WooCommerce_Purchase_Product_Category extends AutomatorWP_Integration_Trigger {
    ...
    public function register() {
        ...
        automatorwp_register_trigger( $this->trigger, array(
            ...
            'label'             => __( 'User purchases a product of a category', 'automatorwp-woocommerce' ),
            'select_option'     => __( 'User purchases a product of <strong>a category</strong>', 'automatorwp-woocommerce' ),
