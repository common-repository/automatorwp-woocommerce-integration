<?php
/**
 * Purchase Product Tag
 *
 * @package     AutomatorWP\Integrations\WooCommerce\Triggers\Purchase_Product_Tag
...
class AutomatorWP_WooCommerce_Purchase_Product_Tag extends AutomatorWP_Integration_Trigger {

    public $integration = 'woocommerce';
    public $trigger = 'woocommerce_purchase_product_tag';
    ...
    public function register() {
        ...
        automatorwp_register_trigger( $this->trigger, array(
            ...
            'label'             => __( 'User purchases a product of a tag', 'automatorwp-woocommerce' ),
            'select_option'     => __( 'User purchases a product of <strong>a tag</strong>', 'automatorwp-woocommerce' ),
            /* translators: %1$s: Term title. %2$s: Number of times. */
            'edit_label'        => sprintf( __( 'User purchases a product of %1$s %2$s time(s)', 'automatorwp-woocommerce' ), '{term}', '{times}' ),
            /* translators: %1$s: Term title. */
            'log_label'         => sprintf( __( 'User purchases a product of %1$s', 'automatorwp-woocommerce' ), '{term}' ),
...
new AutomatorWP_WooCommerce_Purchase_Product_Tag();